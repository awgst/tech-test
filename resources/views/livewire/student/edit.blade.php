<div>
    <form wire:submit.prevent="update" class="space-y-6">
        <div class="bg-white px-4 py-5 shadow sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Student Information</h3>
                    <p class="mt-1 text-sm text-gray-500">Update the student's details.</p>
                </div>
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('student.index') }}" class="rounded-md bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Cancel</a>
